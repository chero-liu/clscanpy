import os
import scanpy as sc
from oescanpy.tools.utils import check_mkdir, check_file_exist, save_figure
from anndata import AnnData
import pandas as pd
from oescanpy.log import log_function_call
from oescanpy.tools.plotting.heatmap import plot_marker_heatmap
import oescanpy as oep
from oescanpy.tools.utils import is_valid_path
...
def write_diff_genes(
    ...
    def save_result(df: pd.DataFrame, filename: str, drop_cols: list = None):
        ...
        df.to_csv(file_path, index=False, sep="\t", encoding="utf-8",mode='a' if file_exists else 'w',header=not file_exists)
